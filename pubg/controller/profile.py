...
from pubg.API.helper import getPlayerId, shardDict
...
@pubg.route('/profile/<player_name>')
...
@pubg.route('/profile/<player_name>/match_history/', defaults={'page': 1})
@pubg.route('/profile/<player_name>/match_history/page/<int:page>')
...
@pubg.route('/profile/<player_name>/statistics')
